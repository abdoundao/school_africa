                ...
                for field in global_search.global_field_ids:
                    if field.name == 'display_name' or field.name == 'name':
                        ...
                        if field.relation:
                            ...
                            if not request.env[field_model].check_access_rights('read', raise_exception=False):
                                ...
                                if not request.env[model_name].check_access_rights('read', raise_exception=False):
